...
use Startcode\CleanCore\Formatter\Collection\CollectionAbstract;
...
abstract class PaginationAbstract extends CollectionAbstract
{
    ...
    /**
     * @return \Startcode\CleanCore\Formatter\Collection\PaginationAbstract
     */
    protected function _setPaginator()
    {
        $iteratorFactory  = new \Startcode\CleanCore\Formatter\Collection\IteratorFactory($this->_getResourceCollection());
